    ...
    places: [
      {
        ...
        tripDuration: 4,
        details:
          '<p>Mentioned in the world’s most iconic places, Rome is an epitome of beauty and history. Apart from being the capital city of Italy, the city also remains as a memorial to the creative imagination of architecture. Due to the 3000 year old ad hoc urban development, the historic centre of Rome is listed as a World Heritage Site by UNESCO. Situated on the central portion of the Italian peninsula, on the Tiber River about 24 km from the Tyrrhenian Sea. Rome is made up of warm colours and historic architectural styles.</p><p>The beauty of this place resides significantly in the churches. There are approximately nine hundred churches, from the Paleochristian and Medieval period to the Gothic, from the Renaissance to the Baroque up until the Modern. Or, you can admire Rome’s beauty during the sunrise and the sunset. The colours become warmer and the city lights start to shine. A city filled with icons of antiquity and the Christian faith, it’s hard to know where to go first. Rome is divided into several districts with its centre, the Colosseo district, including the most ancient attractions like the Colosseum, Capitoline Hill, and the Roman Forum.</p><p>On the outskirts of the centre is Old Rome, featuring the Pantheon, majestic cathedrals, plazas, and Renaissance architecture. There are plenty of activities to do in Rome. For unique cultural experiences, you can visit the Trevi fountain and follow their tradition by tossing a coin into it. Or, you can shop for handicrafts and haute couture from the local market. Also, if you are an art fanatic, you can visit archaeological sites, Baroque churches, villas-turned-museums, for a wonderful experience. Moreover, you can hike up Mount Vesuvius and explore the UNESCO-listed ruins of Pompeii.</p><p>Rome has a Mediterranean climate. Temperatures can stay around 30 degrees in the daytime, but the nights are usually cooler and more comfortable.  In the spring season, Rome has warm weather and summers can be hot and humid. Temperatures in July and August can easily exceed 32 degrees Celsius. Additionally, winter is a really good time to visit. If you want to save money on accommodation, and site tourist attractions without the long lines then plan your vacation in winter.</p>',
      },
      {
        name: 'Venice',
    ...
    places: [
      {
        ...
        tripDuration: 4,
        details:
          '<p>Leh is a dream destination for many travellers in India and even for those who are visiting from overseas. It is not just a destination for solo travelers but has so much to offer to young travellers, families and couples alike. Leh is famous for its high altitudes and numerous passes connecting various locations in this difficult terrain. To explore the best tourist places in Leh, one must visit this frozen paradise to explore its secrets and admire its breath-taking beauty.</p><p>Despite its harsh weather and inaccessibility, it remains a popular tourist destination for people from all over the world. But make sure you are physically fit to endure the harsh weather and difficult terrains of Leh. You must be wondering why visit this place is perfect when the terrain is difficult to navigate. Well, you must visit this place because not only is it a pocket-friendly tourist destination, (provided you book in advance), it is sparsely crowded even during peak season and the local hosts are committed to ensuring you to have a terrific experience</p><p>Leh is a dream destination for many travellers and the holy grail for the adventure enthusiasts. If you are a photography enthusiast then Leh is the paradise you have been waiting for all your life. There isn’t much to offers in terms of nature or wildlife photography, but what you can capture instead is a vast empty canvas that you can paint.</p><p>he landscape here is unlike anywhere in India and worldwide and so much of it is still undiscovered and undocumented. In addition to the mesmerizing landscape, there are many turquoise blue lakes, beautifully constructed monasteries, snow-covered mountains and unimaginable sights that change every few kilometres. It’s safe, economical and you can travel here by yourself, or with your friends, families and even that someone special. Explore tourist places in Leh with the best Leh tour packages which will leave you mesmerized by its beauty.</p>',
      },
      {
        name: 'Manali Kasol',
  ...
  },
  {
    ...
    places: [
      ...
      },
      {
        ...
        tripDuration: 4,
        details:
          '<p>Embark on a tour to the Lady Elliot Island which is located on the Southern Great Barrier Reef and explore to the fullest. This package offers you many activities along with a tour of the island. You can indulge in a glass-bottom boat ride or a snorkeling session, and you can also take a tour of this beautiful island with a professional tour guide. Have a fun time from the beginning of your trip that will be when you board a flight to the island.</p>',
      },
      {
        ...
        tripDuration: 4,
        details:
          '<p>Get close to an amazing world of underwater discovery at Sea Life Sydney Aquarium’s themed exhibits including the Penguin Expedition, Dugong Island and Shark Valley. The Sydney Aquarium has 13,000 animals from 700 different species including majestic dugongs, grey nurse sharks, jellyfish and an array of tropical fish! Among 14 different zones, the newest attraction- Day & Night on the Reef is a definite favorite. From Discovery Rockpool to the Jurassic Seas you can enjoy them all at the SEA LIFE Sydney Aquarium.</p>',
      },
      {
        ...
        tripDuration: 4,
        details:
          '<p>The city of Gold Coast is located on the east coast of Australia, in the state of Queensland. It is the second-largest city in Queensland and the sixth-largest city in Australia. The Gold Coast is a major tourist destination, with its warm climate, beautiful beaches, and surfing conditions.</p><p>With its beautiful beaches, stunning hinterland, and vibrant city life, the Gold Coast has something for everyone. Whether youre looking for a laid-back beach vacation or an action-packed adventure, the Gold Coast has it all. And with so many things to see and do, you ll never be bored. If youre looking for fun in the sun, head to one of the Gold Coasts many beaches.</p><p>The Gold Coast is home to some of Australias best beaches. Surfers paradise is one of the most popular beaches on the Gold Coast. The beach is known for its waves and surfing conditions. Other famous beaches include Broadbeach, Burleigh Heads, and Coolangatta. </p><p>If youre feeling adventurous, take a walk along the coastline and explore what Surfers Paradise offers. Another great activity in Gold Coast is checking out the local markets. From fresh produce to handmade goods, theres something for everyone at the markets.</p>',
      },
    ],
  },
  {
    ...
    places: [
      {
        ...
        tripDuration: 4,
        details:
          '<p>Bangkok Pattaya Phuket package is a 6 days 5 nights package that offers a chance to explore the famous tourist attractions of Phuket, Bangkok, and Pattaya. This package offers meals, accommodation, internal transportation, and sightseeing activities.</p>',
      },
      {
        ...
        tripDuration: 4,
        details:
          '<p>From the crystal clear water, scenic beaches to enthralling adventures and more, Phuket is drawing people to its shores for decades. Often referred to as the Pearl of the Andaman, it is the largest island in Thailand and arguably the most famous one as well. With an exceptional coastline featuring long stretches of white sandy beaches fringed with casuarinas and palms, Phuket is undoubtedly a must-visit destination to have a fun-filled vacation.</p><p>On the other hand, lies the stunning town of Krabi along the coast of Southern Thailand. A place boasts of emerald blue waters, gleaming white sands, limestone cliffs and dense green wildlife sanctuaries. It is a cherry on top for adventure junkies for Krabi offers some thrilling adventure sports like wakeboarding, windsurfing, kitesurfing and much more! Dive through crystal clear waters as you snorkel deep down on the special 4-Island Tour, massage your sore muscles in the Klong Thom and Emerald Pool Hot Springs, theres a lot to do on this thrilling vacation to Thailand.</p>',
      },
      {
        name: 'Raya Islands',
        ...
        tripDuration: 4,
        details:
          '<p>Phuket is considered to be one of the most beautiful places in Thailand with its sandy vast beaches, mountains and serene surroundings. Raya Island or Racha island is considered one of the finest and one of the most beautiful islands in Phuket lying in the Andaman Sea. It is a must-visit for those who love to explore beaches, enjoy a good swim with mind-blowing picture-perfect surroundings, enjoy snorkelling or just look for a time-out from the city and wish to feel calm and rejuvenate their mind and soul alike.</p><p>Have a day out, or go snorkelling, explore the beautiful beach, etc. you can do anything you want in a pristine, heavenly location that will remind you of the scenes in movies that had a beach and you were mesmerized by the scenic blithering view. Have a completely relaxing experience on the Raya island tour.</p>',
      },
      {
        ...
        tripDuration: 4,
        details:
          '<p>Witness a breathtaking panoramic view of Bangkok city as you step into the glass-floored King Power Mahanakhon Tower’s Skywalk. Experience the feeling of being on top of the world as you stand on the roof of one of the tallest buildings in the city while catching sight of the busy streets of Bangkok. The sight of a mesmerizingly serene sunset painting the sky with hues of orange will definitely leave you awestruck. Evenings are extraordinarily beautiful from the skywalk as the city gets lit up with the brightest lights.</p>',
      },
    ],
  },
  {
    ...
    places: [
      {
        ...
        tripDuration: 4,
        details:
          '<p>Jewel Changi Airport is one of the most famous tourist attractions in Singapore with the tallest indoor waterfall called the Rain Vortex. There are a lot of points of interest at this airport for you to explore, like the Canopy Park, Hedge Maze, Manulife Sky Nets and many more. Have a thrilling experience while walking at Canopy Bridge with a glass bottom in the centre. Overall Changi Airport Attraction is a wholesome tour to relax, play and unwind with your friends and family. You can also dine in and go shopping at as many as 300 retail shops.</p>',
      },
      {
        name: 'DUCKtours',
        ...
        tripDuration: 4,
        details:
          '<p>Gear up for an unforgettable tour of Singapore for one hour with DUCKtours. Start your amazing journey from the renowned destination i.e. Suntec City by hoping on a refurbished amphibious vehicle. Enjoy exploring various prominent landmarks during the trip and learn about their fascinating history. Book DUCKtours In Singapore and stroll through the city in a unique way.</p>',
      },
      {
        ...
        tripDuration: 1,
        details:
          '<p>Get the Singapore Night Safari tickets to see a variety of nocturnal animals and observe their behaviour and activities during the Night Safari tour. The Safari has over 2,500 species of nocturnal animals i.e. leopards, badgers, owls, etc. Gain significant information about these animals from a professional guide during the tour. Visit 7 geographical regions of the safari and ride a tram with your family and friends.</p>',
      },
      {
        name: 'Sentosa Fun',
        ...
        tripDuration: 1,
        details:
          '<p>Sentosa Island, also known as the capital of Singapore, is filled with a range of unique & diverse attractions & adventurous activities that you surely wouldnt want to miss experiencing. The Sentosa Fun Pass is your one-stop pass to access over 21 attraction & activities. Book your package based on your preferred number of tokens, and engage in the activities of your choice. There’s plenty of fun for everyone & it begins as soon as you arrive on this island!</p>',
      },
    ],
  },
  {
    ...
    places: [
      {
        ...
        tripDuration: 4,
        details:
          '<p>Burj Khalifa, the gem of Dubai and the worlds tallest building famous for its cloud-piercing height of 828 meters (2716.5 feet), and is the most attractive tourist destination in Dubai. The 148th-floor viewing deck of Burj Khalifa, which is three times taller than the Eiffel Tower, is furnished with avant-garde architecture. Furthermore, beneath its contemporary architecture, the Burj Khalifa boasts numerous intriguing features such as the worlds highest elevator system with a total of 163 floors. You can purchase tickets to the Burj Khalifa and gain insight into the buildings innovative architecture.</p><p>Get a view from the highest outdoor observation deck in the world by booking tickets to the top of Burj Khalifa. Frame this memorable moment with some unique photographs amidst the aerial views of Dubai city. Book Burj Khalifa tickets to make your journey more accessible, with attention from the official ambassador offered throughout the tour of the 148th and 125th floors.</p>',
      },
      {
        name: 'Ain Dubai',
        ...
        tripDuration: 4,
        details:
          '<p>Spend a memorable evening with your special one in Dubai! Experience riding in Ain Dubai and enjoy spectacular night views of this man-made "Bluewaters Island". Get amazed by the astonishing height of the giant Ferris wheel and enjoy a majestic view of Dubai from there. Embark on a luxury dinner cruise experience in a mega yacht and spend some happy moments with your loved one. Enjoy the beautiful views of Dubai as you cruise through Dubai Marina to Atlantis, The Palm, and back - with spectacular views of Ain Dubai lit up at night.</p>',
      },
      {
        name: 'Ferrari World ',
        ...
        tripDuration: 4,
        details:
          '<p>Gear up for a fascinating Abu Dhabi City tour and get to witness the splendor of this majestic city. As you journey to Abu Dhabi, your tour guide will brief you on the local culture and point out some important locations. Take a tour of one of the biggest mosques in the world and marvel at the impressive architecture, which features 82 domes and more than 1000 columns. Also, get to admire the beautiful Heritage Village, the mesmerizing Emirates Palace, and much more on this trip. Make the most of your free time by visiting Ferrari World, the largest indoor theme park with the fastest roller coaster!</p>',
      },
      {
        ...
        tripDuration: 4,
        details:
          '<p>This Dubai City Tour is the perfect blend of traditional side and the new side of Dubai which lets you explore the culture of Dubai in the best way possible. Witness some of the record-breaking structures of Dubai in this tour like Burj Al Arab, Jumeirah Mosque and the tallest building on this planet, the iconic Burj Khalifa.</p><p>Give yourself a desert treat in the evening and enjoy best entertainment shows in a beautiful starlit camp and have the finest BBQ dinner and shisha living a lavish Arabic lifestyle. Also, live the desert life while enjoying some of the thrilling activities like sandboarding and camel riding.</p><p>Dubai has some of the extraordinary activities and dining on a Dhow Cruise is one of them. Dhow Journey in Dubai is like a dream for so many travelers as it offers some of the astonishing sightseeing opportunities. Cruise along the Dubai Creek and witness some of the old souks and appreciate the Arabian lifestyle which will surely take you back in time. Have buffet dinner on the cruise with some Arabian music and enjoy the starry night while cruising along the Dubai Creek.</p>',
      },
    ],
  },
];
      ...
      if (search !== null && search !== '') {
        if (key.destination === search) {
          ...
          const places = key.places.map((place, index) => {
            ...
            return (
              '<div class="col-lg-4 col-md-6"> <div class="single_place"> <div class="thumb"> <a href="destination_details.html?dest=' +
              key.destination +
              '&place=' +
              place.name +
              '"><img src="' +
              place.img +
              '" alt=""></a>  </div> <div class="place_info"> <a href="destination_details.html?dest=' +
              key.destination +
              '&place=' +
              place.name +
              '"><h3>' +
...
function placeDetails(dest, place) {
  var detail = '';
  data.map((key, index) => {
    console.log(key.destination + ' and dest = ' + dest);
    if (key.destination === dest) {
      // loop places to get details
      key.places.map((placekey, index) => {
        console.log(placekey.name + ' and place = ' + place);
        if (placekey.name == place) {
          console.log('found');
          detail = placekey.details;
        }
      });
    }
  });
